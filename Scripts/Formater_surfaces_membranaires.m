...
[FileName,PathName] = uiputfile('*.xls','Save file name','Name_of_cell_membrane'); % Choisis le nom du fichier excel et son emplacement
...
i=1;
 ...
 while i <= Fin(1) %pour tous les fichiers
    ...
    xlswrite([PathName '\' FileName],points,temps); %Ecrit les coordonnées dans un excel dans le sheet donné ayant le temps comme nom
